const DoctorViewReport = () => {
  return (
    <div className="w-full relative [background:linear-gradient(121.5deg,_#eed8ec_23.42%,_#a8edea)] h-[750px] overflow-hidden text-left text-base text-rosybrown font-inter">
      ...
      <div className="absolute top-[104px] left-[82px] w-[1241px] overflow-hidden flex flex-row flex-wrap items-start justify-start p-2.5 box-border gap-[10px]">
        ...
        <div className="w-[1200px] bg-gray-100 h-[420px] overflow-hidden shrink-0 flex flex-col items-center justify-start py-[26px] px-[29px] box-border gap-[43px] text-center text-xl">
          <b className="w-[322px] relative flex items-center justify-center h-6 shrink-0">{`Reports `}</b>
          <div className="w-[1138px] relative text-left inline-block">
